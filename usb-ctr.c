...
__u16 usbDTristateR_USB_CTR(usb_dev_handle *udev)
{
  ...
  */
  ...
  if (usb_control_msg(udev, requesttype, DTRISTATE, 0x0, 0x0, (char*) &data, sizeof(data), HS_DELAY) < 0) {
    perror("usbDTristateR_USB_CTR: error in usb_control_msg().");
  }
  return data;
}
...
void usbDTristateW_USB_CTR(usb_dev_handle *udev, __u16 value)
{
  ...
  */
  ...
  if (usb_control_msg(udev, requesttype, DTRISTATE, value, 0x0, NULL, 0x0, HS_DELAY) < 0) {
    perror("usbDTristateW_USB_CTR: error in usb_control_msg()");
  }
  return;
}
...
__u16 usbDPort_USB_CTR(usb_dev_handle *udev)
{
  ...
  */
  ...
  if (usb_control_msg(udev, requesttype, DPORT, 0x0, 0x0, (char*) &data, sizeof(data), HS_DELAY) < 0) {
    perror("usbDPort_USB_CTR: error in usb_control_msg().");
  }
  return data;
}
...
__u16 usbDLatchR_USB_CTR(usb_dev_handle *udev)
{
  ...
  */
  ...
  if (usb_control_msg(udev, requesttype, DLATCH, 0x0, 0x0, (char *) &data, sizeof(data), HS_DELAY) < 0) {
    perror("usbDLatchR_USB_CTR: error in usb_control_msg().");
  }
  return data;
}
...
void usbDLatchW_USB_CTR(usb_dev_handle *udev, __u16 value)
{
  ...
  */
  ...
  if (usb_control_msg(udev, requesttype, DLATCH, value, 0x0, NULL, 0x0, HS_DELAY) < 0) {
    perror("usbDLatchW_USB_CTR: error in usb_control_msg().");
  }
  return;
}
...
void usbCounterSet_USB_CTR(usb_dev_handle *udev, __u8 counter, __u64 count)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, COUNTER, 0x0, counter, (char *) &count, sizeof(count), HS_DELAY);
  return;
}
...
void usbCounterModeR_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 *mode)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, COUNTER_MODE, 0x0, counter, (char *) mode, 0x1, HS_DELAY);
}
...
void usbCounterModeW_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 mode)
{
  ...
  usb_control_msg(udev, requesttype, COUNTER_MODE, mode, counter, NULL, 0x0, HS_DELAY);
}
...
void usbCounterOptionsR_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 *options)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, COUNTER_OPTIONS, 0x0, counter, (char *) options, 0x1, HS_DELAY);
}
...
void usbCounterOptionsW_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 options)
{
  ...
  usb_control_msg(udev, requesttype, COUNTER_OPTIONS, options, counter, NULL, 0x0, HS_DELAY);
}
...
void usbCounterDebounceR_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 *debounce)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, COUNTER_DEBOUNCE, 0x0, counter, (char *) debounce, 0x1, HS_DELAY);
}
...
void usbCounterDebounceW_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 debounce)
{
  ...
  usb_control_msg(udev, requesttype, COUNTER_DEBOUNCE, debounce, counter, NULL, 0x0, HS_DELAY);
}
...
void usbCounterGateConfigR_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 *options)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, COUNTER_GATE_CONFIG, 0x0, counter, (char *) options, 0x1, HS_DELAY);
}
...
void usbCounterGateConfigW_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 options)
{
  ...
  usb_control_msg(udev, requesttype, COUNTER_GATE_CONFIG, options, counter, NULL, 0x0, HS_DELAY);
}
...
__u8 requesttype = (DEVICE_TO_HOST | VENDOR_TYPE | DEVICE_RECIPIENT);
  ...
  usb_control_msg(udev, requesttype, COUNTER_OUT_CONFIG, 0x0, counter, (char *) options, 0x1, HS_DELAY);
}
...
void usbCounterOutConfigW_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 options)
{
  ...
  usb_control_msg(udev, requesttype, COUNTER_OUT_CONFIG, options, counter, NULL, 0x0, HS_DELAY);
}
...
void usbCounterOutValuesR_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 index, __u64 *value)
{
  ...
  */
  ...
  if (usb_control_msg(udev, requesttype, COUNTER_OUT_VALUES, index, counter, (char *) value, 0x8, HS_DELAY) < 0) {
    perror("usbCounterOutValuesR_USB_CTR: error in usb_control_msg().");
  }
}
...
void usbCounterOutValuesW_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 index, __u64 value)
{
  ...
  if (usb_control_msg(udev, requesttype, COUNTER_OUT_VALUES, index, counter, (char *) &value, 0x8, HS_DELAY) < 0) {
    perror("usbCounterOutValuesW_USB_CTR: error in usb_control_msg().");
  }
}
...
void usbCounterLimitValuesR_USB_CTR(usb_dev_handle *udev, __u8 counter, __u8 index, __u64 *value)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, COUNTER_LIMIT_VALUES, index, counter, (char *) value, 0x8, HS_DELAY);
}
...
void usbCounterParamsR_USB_CTR(usb_dev_handle *udev, __u8 counter, CounterParams *params)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, COUNTER_PARAMETERS, 0x0, counter, (char *) data, sizeof(data), HS_DELAY);
...
void usbScanConfigR_USB_CTR(usb_dev_handle *udev, __u8 lastElement, ScanList *scanList)
{
  ...
  usb_control_msg(udev, requesttype, SCAN_CONFIG, 0x0, lastElement, (char *) scanList->scanList, 33, HS_DELAY);
...
void usbScanStart_USB_CTR(usb_dev_handle *udev, __u32 count, __u32 retrig_count, __u32 pacer_period, __u8 options)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, SCAN_START, 0x0, 0x0,(char *) data, sizeof(data), HS_DELAY);
}
...
void usbScanStop_USB_CTR(usb_dev_handle *udev)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, SCAN_STOP, 0x0, 0x0, NULL, 0x0, HS_DELAY);
}
...
void usbScanClearFIFO_USB_CTR(usb_dev_handle *udev)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, SCAN_CLEAR_FIFO, 0x0, 0x0, NULL, 0x0, HS_DELAY);
}
...
void usbScanBulkFlush_USB_CTR(usb_dev_handle *udev, __u8 count)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, BULK_FLUSH, count, 0x0, NULL, 0x0, HS_DELAY);
}
...
void usbTimerPeriodR_USB_CTR(usb_dev_handle *udev, __u8 timer, __u32 *period)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, TIMER_PERIOD, 0x0, timer, (char *) period, sizeof(period), HS_DELAY);
}
...
void usbTimerParamsR_USB_CTR(usb_dev_handle *udev, __u8 timer, TimerParams *params)
{
  ...
  */
  ...
  usb_control_msg(udev, requesttype, TIMER_PARAMETERS, 0x0, timer, (char *) data, sizeof(data), HS_DELAY);
