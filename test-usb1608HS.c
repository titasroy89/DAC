...
int main (int argc, char **argv)
{
  ...
  while(1) {
	...
	usbAInScanStart_USB1608HS(udev);
	  ...
	  ret = usb_bulk_read(udev, USB_ENDPOINT_IN|1, (char *) data1, nbytes, 1000);
	  write(fd, data1, nbytes);
	  ret = usb_bulk_read(udev, USB_ENDPOINT_IN|1, (char *) data2, nbytes, 1000);
